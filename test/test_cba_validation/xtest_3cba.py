...
def test_valuation_wo_data():
    assert_ran(DIR / '102-cba_valuation.csv', )


def test_sensitivity_evaluation():
    assert_ran(DIR / '103-cba_valuation_sensitivity.csv', )


def test_coupled_evaluation():
    assert_ran(DIR / '104-cba_valuation_coupled_dt.csv', )
...
def test_monthly():
    assert_ran(DIR / '107-cba_monthly.csv', )
...
def test_catch_wrong_length():
    ...
    with pytest.raises(ModelParameterError):
        assert_ran(DIR / '103-catch_wrong_length.csv', )
