...
ERROR_BOUND = 3
ROOT_DIR = Path("./test/test_validation_report_sept1")
...
class TestUseCase1A:
    ...
    def setup_class(self):
        ...
        self.results = run_case(ROOT_DIR / USECASE1 / mp_name)
        self.validated_folder = ROOT_DIR / Path("./Results/Usecase1/es")
...
class TestUseCase1B:
    ...
    def setup_class(self):
        ...
        self.results = run_case(ROOT_DIR / USECASE1 / mp_name)
        self.validated_folder = ROOT_DIR / Path("./Results/Usecase1/ES+PV")
...
class TestUseCase1C:
    ...
    def setup_class(self):
        ...
        self.results = run_case(ROOT_DIR / USECASE1 / mp_name)
        self.validated_folder = ROOT_DIR / Path("./Results/Usecase1/es+pv+dg_step2")
...
class TestUseCase2A1:
    ...
    def setup_class(self):
        self.mp_name = ROOT_DIR / USECASE2 / "Model_Parameters_Template_Usecase3_Planned_ES.csv"
        self.results = run_case(self.mp_name)
        self.validated_folder = ROOT_DIR / Path("./Results/Usecase2/es/Step1")
    ...
    def test_size_results_are_expected(self):
        compare_size_results(self.results, self.validated_folder / "sizeuc3_es_step1.csv",
                             ERROR_BOUND)
...
class TestUseCase2A2:
    ...
    def setup_class(self):
        self.mp_name = ROOT_DIR / USECASE2 / "Model_Parameters_Template_Usecase3_Planned_ES_Step2.csv"
        self.results = run_case(self.mp_name)
        self.validated_folder = ROOT_DIR / Path("./Results/Usecase2/es/Step2")
...
class TestUsecase2B1:
    ...
    def setup_class(self):
        self.mp_name = ROOT_DIR / USECASE2 / "Model_Parameters_Template_Usecase3_UnPlanned_ES+PV.csv"
        self.results = run_case(self.mp_name)
        self.validated_folder = ROOT_DIR / Path("./Results/Usecase2/es+PV/Step1")
...
class TestUsecase2B2:
    ...
    def setup_class(self):
        self.mp_name = ROOT_DIR / USECASE2 / "Model_Parameters_Template_Usecase3_UnPlanned_ES+PV_Step2.csv"
        self.results = run_case(self.mp_name)
        self.validated_folder = ROOT_DIR / Path("./Results/Usecase2/es+pv/Step2")
...
class TestUsecase2C1:
    ...
    def setup_class(self):
        self.mp_name = ROOT_DIR / USECASE2 / "Model_Parameters_Template_Usecase3_UnPlanned_ES+PV+DG_Step1.csv"
        self.results = run_case(self.mp_name)
        self.validated_folder = ROOT_DIR / Path("./Results/Usecase2/es+pv+dg/step1")
...
class TestUsecase2C2:
    ...
    def setup_class(self):
        self.mp_name = ROOT_DIR / USECASE2 / "Model_Parameters_Template_Usecase3_UnPlanned_ES+PV+DG_Step2.csv"
        self.results = run_case(self.mp_name)
        self.validated_folder = ROOT_DIR / Path("./Results/Usecase2/es+pv+dg/step2")
