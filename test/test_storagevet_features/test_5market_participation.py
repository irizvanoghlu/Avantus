...
"""
import pytest
from test_storagevet_features.TestingLib import assert_ran
...
@pytest.mark.slow
def test_batt():
    assert_ran(DIR / "200-DA_FR_SR_NSR_battery_month.csv")


def test_pv_ice():
    assert_ran(DIR / "202-DA_FR_SR_NSR_pv_ice_month.csv")


def test_batt_pv_ice():
    assert_ran(DIR / "203-DA_FR_SR_NSR_battery_pv_ice_month.csv")


@pytest.mark.slow
def test_batt_ts_constraints():
    assert_ran(DIR / "201-DA_FR_SR_NSR_battery_month_ts_constraints.csv")
